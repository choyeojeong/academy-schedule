          ...
          <table border="1" cellPadding="6" style={{ width: '100%' }}>
            ...
            <tbody>
              {lessonsOnDate.map((lesson, idx) => {
                ...
                const isOriginalAbsence =
                  status.startsWith('결석 (') && !status.startsWith('보강');
                ...
                return (
                  <tr key={lesson.id}>
                    ...
                    <td>
                      {isAttendance ? (
                        `${lesson.start?.slice(0, 5)} - ${lesson.end?.slice(
                          0,
                          5
                        )}`
                      ) : isOriginalAbsence ? (
                        ...
                        <>
                          ...
                          {editingId === lesson.id ? (
                            <div>
                              ...
                              <button
                                onClick={() =>
                                  handleAttend(lesson, startTimes[lesson.id])
                                }
                              >
                                저장
                              </button>
                              <button onClick={() => handleAttend(lesson)}>
                                지금부터
                              </button>
                            ...
                            <>
                              <button onClick={() => setEditingId(lesson.id)}>
                                출석
                              </button>
                              <button
                                onClick={() =>
                    ...
                    <td>
                      <input
                        ...
                        onBlur={(e) =>
                          handleNoteChange(lesson.id, e.target.value)
                        }
                      />
                    </td>
                    <td>
